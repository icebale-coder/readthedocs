...
```
Бывает, то какой-нибудь коммутатор c STP "сходит с ума", например на нем перестает работать процесс STP и тогда в таком случае возникает петля "на все деньги"...
...
- Обязательно! Фильтровать BPDU там, где мы их не ожидаем увидеть (на ацесс портах). Включать портфаст на этих портах.
