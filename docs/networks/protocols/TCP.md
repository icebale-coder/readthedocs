...
![icmp-ping](img/tcp/3way-hangshake.jpg)
...
![icmp-ping](img/tcp/3way-hangshake-fin.jpg)
...
Третий байт – это Shift count (размер битового сдвига влево), 
т.е. multiplier(множитель) = 2 ^Shift count
...
#### Эволюция меъханизма Congetion control
