...
На практике предпочтение отдали ручному режиму определению соседей по VLSP домену, за его простоту настройки. Также есть централизованные контроллеры, которые допивают конфигурацию согласно VPLS домену.
