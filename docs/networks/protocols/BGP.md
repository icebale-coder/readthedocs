...
динамическим протоколом маршутизации EGP (External Gateway Protocol)...
...
Является на сегодняшний день единственным в природе динамический протокол маршутизации  EGP (External Gateway Protocol) - берегите BGP )))
