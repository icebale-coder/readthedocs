...
# Применить изменения с их автоматическим откатом через определенное время - commit confirm [minite]

Очень удобно если не уверен, что твой комит не поломает доступ к "коробке".
Например команда полезна при работах на правилах copp на firewall.

Где при неправильной конфигурации можно потерять доступ к устройству.
