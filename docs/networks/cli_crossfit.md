...
AS31133 - это Мегафон, это конечная AS-ка, которая передала нам данный префикс, по сути первая AS-ка в AT-PATH

```

!!!warning  "Важно"
            AS-PATH строится в обратной последовательности относительно пути перендачи префикса по AS.
...
<details><summary>4. Показать все префиксы, рожденные в АS48302 (ATOMLINK-AS) и пришедшие к нам через Мегафон</summary>
<p>
